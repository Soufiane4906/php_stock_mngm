    ...
    <div id="main">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-md table-striped" id="table">
                                        ...
                                        <tbody>
                                            ...
                                            require_once PROJECT_ROOT . "/Metier/client.php";
                                            require_once PROJECT_ROOT . "/Metier/commande.php";
                                                                ...
                                                                <div class="modal-body" id="<?=$t->get("n")?>">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-md " id="table">
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                            require_once PROJECT_ROOT . "/Metier/ligneCmd.php";
        ...
        <script>
            function print(ref){
            var mywindow = window.open(`http://localhost/gestion_stock/Projet_Web_TP/Presentation/Commande/pdf.php?ref=${ref}`, 'PRINT', 'height=400,width=600');
            mywindow.focus();
            mywindow.print();
            }
        </script>